	...
	register_post_type(
		...
		array(
			'labels'                => array(
				...
				'not_found'                => __( 'No block area found.' ),
				'not_found_in_trash'       => __( 'No block areas found in Trash.' ),
				'filter_items_list'        => __( 'Filter block areas list' ),
				'items_list_navigation'    => __( 'Block areas list navigation' ),
				'items_list'               => __( 'Block areas list' ),
				'item_published'           => __( 'Block area published.' ),
				'item_published_privately' => __( 'Block area published privately.' ),
				'item_reverted_to_draft'   => __( 'Block area reverted to draft.' ),
				'item_scheduled'           => __( 'Block area scheduled.' ),
				'item_updated'             => __( 'Block area updated.' ),
			),
			'public'                => false,
			'show_ui'               => true,
			'show_in_menu'          => false,
